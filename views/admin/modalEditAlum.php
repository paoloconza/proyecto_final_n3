<!-- Main modal -->
<div id="authentication-modal2" tabindex="-1" aria-hidden="true" class="flex overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full h-[calc(100%-1rem)] max-h-full hidden">
    <div class="relative p-4 w-full max-w-sm max-h-full">
        ...
        <div class="relative bg-white rounded shadow border border-gray-300">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                ...
                <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="authentication-modal2">
